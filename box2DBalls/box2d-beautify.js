...
if (goog[W8y.m6Q]) {
    ...
    goog[W8y.J9k] = W8y.L0r.v0r("5be8") ? 1.5 : function() {
        ...
        return typeof P != W8y.i7H && W8y[N](f, P);
    };
...
goog[W8y.Z6H] = function(f) {
    var N = "getFullYear";
    return goog[W8y.O50](f) && typeof f[N] == W8y.z86;
};
...
goog[W8y.L67] = function(f) {
    ...
    if (goog[W8y.p0k][W8y.t50]) {
        ...
        if (W8y[k](goog[W8y.w0r], W8y.z6k)) {
            ...
            if (typeof goog[W8y.p0k][n] != W8y.i7H) {
...
box2d.b2Controller.prototype.RemoveBody = function(f) {
    ...
    var m = this[W8y.I80];
    while (m && W8y[W](m[W8y.R6k], f)) m = m[W8y.i2k];
    if (box2d[W8y.l3H]) {
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function(f, N, P, Z) {
    ...
    while (W8y[H](x1, D1)) {
        ...
        if (W8y[n](x1, D1)) B1 = G1;
        else B1 = this[W8y.N4k][x1];
...
box2d[W8y.b9M] = function(f, N, P, Z, W) {
    ...
    var W1 = box2d[W8y.T67](m1, box2d[W8y.b9M][W8y.q1r]),
        ...
        j1, G1 = box2d[W8y.F7M](C1, box2d[W8y.b9M][W8y.J67]);
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function() {
    var f = "d8z",
        ...
        d = "r9z",
        u = "H9z",
        D, M, y1, h, E, L, w1, B, N1, f1, c1, l1, P1, s1, b1, m1, W1, J1, C1, x1, T1, K1, V1, Q1, D1, d1 = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA,
        ...
        G1, I1, e1, S1, B1, a1, F1, n4, h1, t1, R4, r4, w4, d4, H4, M4, k4, D4, Y4, W4 = W8y.G2r;
...
box2d.b2ContactSolver.prototype.WarmStart = function() {
    var f = "F8z",
        ...
        P = "L8z",
        Z = "u8z",
        W, l, m, C, n, k, H, i, Q, e, j, o, S, d, u, D, M, y1, h, E = box2d.b2ContactSolver.prototype.WarmStart.s_P;
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function() {
    var f = "w1S",
        ...
        m1 = "U6z",
        W1 = "y6z",
        J1, C1, x1, T1, K1, V1, Q1, D1, d1, u1, j1, G1, I1, e1, S1, B1, a1, F1, n4, h1, t1 = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv,
        ...
        w4, d4, H4, M4, k4, D4 = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P,
        Y4, W4, A1 = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_a,
        L4 = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_b,
        B4, G4, P4 = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x,
...
box2d.b2ContactSolver.prototype.SolvePositionConstraints = function() {
    var f = "z1S",
        ...
        m = "r1S",
        C = "H1S",
        n, k, H, i, Q, e, j, o, S, d, u, D, M, y1, h, E, L, w1, B = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA,
        ...
        c1, l1, P1, s1 = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA,
        b1 = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rB,
        m1, W1, J1, C1, x1, T1 = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_P,
        K1 = W8y.u8Q;
...
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints = function(f, N) {
    var P = "a4S",
        ...
        Q = "f4S",
        e = "t1S",
        j, o, S, d, u, D, M, y1, h, E, L, w1, B, N1, f1, c1, l1, P1, s1 = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_xfA,
        ...
        W1, J1, C1, x1 = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rA,
        T1 = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rB,
        K1, V1, Q1, D1, d1, u1 = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_P,
        j1 = W8y.u8Q;
...
box2d.b2Color.prototype.MakeStyleString = function(f) {
    var N = "C0a",
        ...
        H = (typeof(f) === W8y.i7H) ? (W8y.i0M) : (Math[l](W8y.u8Q, Math[W](W8y.D8Q, f)));
...
box2d.b2Body.prototype.DestroyFixture = function(f) {
    ...
    while (W8y[l](H, W8y.z6k)) {
        if (W8y[W](H, f)) {
            if (i) i[W8y.X66] = f[W8y.X66];
            else this[W8y.l8H] = f[W8y.X66];
            Q = W8y.f5k;
            break;
        }
        i = H;
...
Phaser.Physics.Box2D.prototype = {
    ...
    setBoundsToWorld: function(f, N, P, Z, W, l) {
        var m = "setBounds";
    ...
    setBounds: function(f, N, P, Z, W, l, m, C, n, k) {
        var H = "bottom";
        if (typeof W === 'undefined') {
            W = true;
        }
    ...
    getFixturesAtPoint: function(P, Z, W, l) {
        var m = function(f) {
            var N = "u8C";
    ...
    getBodiesAtPoint: function(Z, W, l, m) {
        var C = "p8C",
            n = "L8C";
        if (typeof l === 'undefined') {
            l = false;
    ...
    distanceJoint: function(f, N, P, Z, W, l, m, C, n) {
        var k = "Z6C";
        if (typeof Z === 'undefined') {
            Z = 0;
        }
    ...
    ropeJoint: function(f, N, P, Z, W, l, m) {
        var C = "W6C";
        if (typeof Z === 'undefined') {
            Z = 0;
        }
    ...
    revoluteJoint: function(f, N, P, Z, W, l, m, C, n, k, H, i) {
        if (typeof P === 'undefined') {
            P = 0;
        }
        if (typeof Z === 'undefined') {
    ...
    prismaticJoint: function(f, N, P, Z, W, l, m, C, n, k, H, i, Q, e, j) {
        if (typeof P === 'undefined') {
            P = 1;
        }
        if (typeof Z === 'undefined') {
    ...
    frictionJoint: function(f, N, P, Z, W, l, m, C) {
        if (typeof W === 'undefined') {
            W = 0;
        }
        if (typeof l === 'undefined') {
    ...
    weldJoint: function(f, N, P, Z, W, l, m, C) {
        if (typeof P === 'undefined') {
            P = 0;
        }
        if (typeof Z === 'undefined') {
    ...
    motorJoint: function(f, N, P, Z, W, l, m, C) {
        if (typeof l === 'undefined') {
            l = 0;
        }
        if (typeof m === 'undefined') {
    ...
    wheelJoint: function(f, N, P, Z, W, l, m, C, n, k, H, i, Q) {
        if (typeof m === 'undefined') {
            m = 0;
        }
        if (typeof C === 'undefined') {
    ...
    pulleyJoint: function(f, N, P, Z, W, l, m, C, n, k, H, i, Q) {
        if (typeof P === 'undefined') {
            P = 0;
        }
        if (typeof Z === 'undefined') {
    ...
    clearTilemapLayerBodies: function(f, N) {
        var P = "destroy";
        N = f[W8y.K67](N);
    ...
    convertTilemap: function(f, N, P, Z) {
        var W = "h6C",
            l = "D6C",
            m = "S6C",
            C = "o6C",
...
Phaser.Physics.Box2D.Body.prototype = {
    setBodyContactCallback: function(f, N, P) {
        var Z = "Q5C",
            W = -1;
        if (f['id']) {
            W = f[W8y.W6M];
    ...
    setFixtureContactCallback: function(f, N, P) {
        var Z = "j5C",
            W = f[W8y.W6M];
        if (W > -1) {
            if (W8y[Z](N, null)) {
    ...
    setCategoryContactCallback: function(f, N, P) {
    ...
    setBodyPresolveCallback: function(f, N, P) {
        var Z = "R5C",
            W = -1;
        if (f['id']) {
            W = f[W8y.W6M];
    ...
    setFixturePresolveCallback: function(f, N, P) {
        var Z = "E5C",
            W = f[W8y.W6M];
        if (W > -1) {
            if (W8y[Z](N, null)) {
    ...
    setCategoryPresolveCallback: function(f, N, P) {
    ...
    setBodyPostsolveCallback: function(f, N, P) {
        var Z = "v5C",
            W = -1;
        if (f['id']) {
            W = f[W8y.W6M];
    ...
    setFixturePostsolveCallback: function(f, N, P) {
        var Z = "G5C",
            W = f[W8y.W6M];
        if (W > -1) {
            if (W8y[Z](N, null)) {
    ...
    setCategoryPostsolveCallback: function(f, N, P) {
    ...
    setCollisionCategory: function(f, N) {
    ...
    addRectangle: function(f, N, P, Z, W) {
        var l = "s1Q",
            m = "X1Q";
        if (typeof f === 'undefined') {
            f = 16;
    ...
    addLoop: function(f, N, P) {
        return this[W8y.L86](f, N, P, true);
    },
    addPolygon: function(f, N, P) {
        var Z = "L1Q",
            W = "setFromXYObjects",
            l = "u1Q",
            m = "d1Q",
    ...
    setRectangle: function(f, N, P, Z, W) {
        this[W8y.f4M]();
        return this[W8y.h97](f, N, P, Z, W);
    },
    setRectangleFromSprite: function(f) {
        if (typeof f === 'undefined') {
            f = this[W8y.M9k];
        }
        this[W8y.f4M]();
    ...
    setLoop: function(f, N, P) {
        var Z = "setChain";
        return this[Z](f, N, P, true);
    },
    setPolygon: function(f, N, P) {
        var Z = "addPolygon",
            W = "Z4Q",
            l = "U4Q";
        if (typeof f === 'undefined') {
